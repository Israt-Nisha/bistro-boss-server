...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ryeft.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
// use verify admin after verifytoken
  ...
  app.patch('/menu/:id',veryfyToken, verifyAdmin, async (req, res) => {
    const item = req.body;
    const id = req.params.id;
    const filter = {_id: new ObjectId(id)};
    const updatedDoc = {
